...
// 改变顶部下载导航状态
export const changeDownloadNavState = ({ dispatch }, isShow) => {
    dispatch('CHANGE_DOWNLOADNAV_STATE', isShow);
};

// 改变路由
export const changeRouterName = ({ dispatch }, routerName) => {
    dispatch('CHANGE_ROUTER_NAME', routerName);
};
